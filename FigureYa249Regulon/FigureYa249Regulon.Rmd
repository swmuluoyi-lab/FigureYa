...
dpi_filtered <- try(
  suppressWarnings(
    tni.dpi.filter(rtni_hepg2_oa, eps = 0, sizeThreshold = TRUE, minRegulonSize = 15)
  ),
  silent = TRUE
)
...
rtnigsea_hepg2_oa <- tni.gsea2(rtni_hepg2_oa, regulatoryElements = regulatoryElements)
